namespace crm_software_back.Models
{
    public static class EmailBody
    {
        ...
        public static string EmailStringBody2(string email, string username, string password, string firstName)
        {
            return $@"<html>
                <head>
                </head>
                        ...
                        <div>
                            <div>
                                ...
                                <p> 
                                    ...
                                    <br>
                                    <br>
                                    <a href=""http://localhost:3000/edit-profile={email}"" target=""_blank"" style=""background-color:#457b9d;padding:10px; border:none;color:#fff;border-radius:4px;display:block;margin:0 auto;width:50%;text-align:center;text-decoration:none"">
                                        Login
                                    </a>
                                    <br>
                                    <br>
